...
def load_shaders():
    shaderList = []
    shaderList.append(createShader(GL_VERTEX_SHADER, open("shaders/bump_mapping/vertex.gsl")))
    shaderList.append(createShader(GL_TESS_EVALUATION_SHADER, open("shaders/bump_mapping/tess_eval.gsl")))
    shaderList.append(createShader(GL_TESS_CONTROL_SHADER, open("shaders/bump_mapping/tess_ctl.gsl")))
    shaderList.append(createShader(GL_FRAGMENT_SHADER, open("shaders/bump_mapping/frag.gsl")))
