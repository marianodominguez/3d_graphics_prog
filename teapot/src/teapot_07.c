/**
 * Smooth shading, instead of using the same normal, calculate the normals
 * in vertices and use interpolation.
 *
 * For normals we use the derivative of bezier function un the 2 directions.
 * For interpolation, we use barycentric coordinates. this is not required, but
